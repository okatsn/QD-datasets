...
@testset "CatalogPreprocess.jl" begin
    for f in testfiles
...
@testset "DocTests" begin
    DocMeta.setdocmeta!(CatalogPreprocess, :DocTestSetup, :(using CatalogPreprocess); recursive=true)
    # using the package everywhere in the doc
    # See also https://documenter.juliadocs.org/stable/man/doctests/#Setup-Code


    doctest(CatalogPreprocess; manual = false) # this makes jldoctest also be tested in a local test
end
